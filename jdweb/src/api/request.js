...
const requests = axios.create({
  baseURL:
    "https://raw.githubusercontent.com/MiaoPaSiWeb/jingdong-web/main/jdweb/src/mock", //基础路径发送请求的时候就不用配置api了
  //   baseURL: "https://gitee.com/tommen-data/jingdong-web/raw/master/mock", //有跨域问题
